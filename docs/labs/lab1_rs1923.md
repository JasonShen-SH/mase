...
In <code>pass-args</code>, for the convolution layer, we set its quantized weight_width to be 8 and weight_frac_width to be 4. The same quantization apply to its data and bias.


## 6. Write code to show and verify that the weights of these layers are indeed quantised. 

There are mainly two methods of quantisation: Post-Training Quantisation (PTQ) and Quantization Aware Training (QAT).

We've found that the quantisation in our task is Post-Training Quantisation (PTQ), mainly from the following code:
...
Same quantization process apply to x and b.
</pre>
...
<img src="../../imgs/ptq_training.png" width="700" />

<img src="../../imgs/ptq_inference.png" width="700" />
