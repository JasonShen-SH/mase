...
We've performed the same quantisation flow to our self-designed JSC  network in lab1. As it contains convolution layer, we customize <pre>pass-arg</pre> file.
