...
And we get the parameters of jsc_rs1923 to be 3285, which is approximately 10 times than that of jsc_tiny(
...
In conclusion, by incorporating 1D convolutional layers and residual modules, we have enabled the network to learn deeper-level features, thus ahieving better performance.
