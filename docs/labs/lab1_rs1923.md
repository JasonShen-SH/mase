...
<img src="../../imgs/2_4.png" width="700" />
...
We've found that the quantisation in our task is Post-Training Quantisation (PTQ):
...
Therefore, no training process is performed during training. We could conclude that our quantization process is Post-Training Quantisation (PTQ).
</pre>
